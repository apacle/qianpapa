...
public class QrCodeUtils {
    ...
    private static void insertImage(BufferedImage source, String logoPath, boolean needCompress) throws IOException {
        ...
        try {
            Image src = null;
            //外链
            if (logoPath.indexOf("http") != -1) {
                HttpURLConnection connection = (HttpURLConnection) new URL(logoPath).openConnection();
                ...
                inputStream = QrCodeUtils.class.getClassLoader().getResourceAsStream(logoPath);
                src = ImageIO.read(inputStream);
            }
