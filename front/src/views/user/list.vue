<template>
  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="拼命加载中" border fit highlight-current-row>
      ...
      <el-table-column label="昵称" width="90" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="电话" width="115" align="center">
        <template slot-scope="scope">
          <a :href="'tel: + scope.row.userPhone + '">{{ scope.row.userPhone }}</a>
        </template>
      </el-table-column>
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['ID', '名字', '电话', '地址', '业务员', '状态']
        const filterVal = ['userId', 'userName', 'userPhone', 'userAddress', 'userStatus', 'userName']
